`GAPIT.RandomModel` <-
function(GWAS=NULL,GWAS.sig=NULL,Y,CV=NULL,X,cutOff=0.01,GT=NULL,name.of.trait=NULL,N.sig=NULL,n_ran=500,ld.cut=FALSE){
...
#BJK    library("lme4")
    ...
    if(is.null(GWAS)&is.null(GWAS.sig)) stop("Please give GWAS or significant results as last !!!")
    if(!is.null(GWAS))
    {
